    ...
    <div className="flex h-full flex-col space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Upload a PDF — works with tables, reports, and documents.</p>
        </div>
      </div>
      ...
      {!sourceId && (
        ...
        >
          ...
          {uploading ? (
            <p className="text-sm font-medium text-slate-600">Uploading & analyzing PDF…</p>
          ) : (
            <>
              <p className="font-medium text-slate-700">Drop your PDF file here</p>
              <p className="text-sm text-slate-400">.pdf supported · max 50 MB</p>
            </>
          )}
